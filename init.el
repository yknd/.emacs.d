...
(when os-type-mac
  ...
  (set-face-attribute 'fixed-pitch nil :family "Cica-18")
  (set-face-attribute 'variable-pitch nil :family "Cica-18")
  (add-to-list 'default-frame-alist '(font . "Cica-18"))
  (set-face-font 'font-lock-comment-face "Cica-18")
  (set-face-font 'font-lock-string-face "Cica-18")
  (set-face-font 'font-lock-keyword-face "Cica-18")
  (set-face-font 'font-lock-builtin-face "Cica-18")
  (set-face-font 'font-lock-function-name-face "Cica-18")
  (set-face-font 'font-lock-variable-name-face "Cica-18")
  (set-face-font 'font-lock-type-face  "Cica-18")
  (set-face-font 'font-lock-constant-face "Cica-18")
  (set-face-font 'font-lock-warning-face "Cica-18")
